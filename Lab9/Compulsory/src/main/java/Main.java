import com.example.demo.GenresEntity;
import com.example.demo.MoviesEntity;
import com.example.demo.MyEntityManager;
...
//
            ...
            MyEntityManager myEntityManager = MyEntityManager.getInstance();
            EntityManagerFactory entityManagerFactory = myEntityManager.getEntityManagerFactory();
            ...
            genresEntity.setId("19999112");
            genresEntity.setName("Romance");
